...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-white/10 hover:text-white focus-visible:ring-2 active:bg-white/20 active:text-white disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-black/50 data-[active=true]:font-medium data-[active=true]:text-white data-[active=true]:rounded-[16px_0_16px_0] data-[state=open]:hover:bg-white/10 data-[state=open]:hover:text-white [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:bg-white/10 hover:text-white",
        outline:
          "bg-transparent shadow-[0_0_0_1px_rgba(255,255,255,0.3)] hover:bg-white/10 hover:text-white hover:shadow-[0_0_0_1px_rgba(255,255,255,0.5)]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
